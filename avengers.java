...
public class avengers extends JFrame {
...
userMenu.setBorder(BorderFactory.createEmptyBorder(10, 20, 10, 20));
        ...
        menuBar.add(Box.createHorizontalStrut(100)); // Add space between title and Home button
        ...
        String paragraphHTML = "<html><div style='text-align:center; color: white;font-size:13px;'>"
                + "<h1><b><big>Avengers:Endgame(2019)</big></h1><br><h2><b>Action/Adventure/Sci-Fi</b></h2><br>"
                + "After the devastating events of Avengers: Infinity War (2018),the universe is in ruins due to<br>"
                + " the efforts of the Mad Titan, Thanos. With the help of remaining allies, the Avengers must<br> "
                + "assemble once more in order to undo Thanos's actions and undo the chaos to the universe, no<br> "
...
ImageIcon imageIcon = new ImageIcon("C:\\Users\\hp\\OneDrive\\Documents\\"
        + "NetBeansProjects\\cinemaproject1\\src\\cinemaproject1\\avengersend.jpg"); // Replace "your_image_path.jpg" with the actual path to your image
...
torrent720Button.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                // Open trending page
                avengersdownload avengersPage = new avengersdownload();
                avengersPage.setVisible(true);
                dispose(); // Close current frame
            }
        });
torrent1080Button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                openMagnetLink("C:\\Users\\hp\\OneDrive\\Documents\\NetBeansProjects\\cinemaproject1\\src\\"
                        + "cinemaproject1\\Interstellar.2014.720p.BluRay.x264.YIFY.srt");
            }
...
JLabel directorLabel = new JLabel("<html><div style='text-align:center; color: white;font-size:13px;margin-left:500px;'><u>Director:</u><p style='color:blue;font-size:15px;'> Anthony Russo</p></div></html>");
JLabel castLabel1 = new JLabel("<html><div style='text-align:center; color: white;font-size:13px;margin-left:500px;'><u>Cast:</u> Taika Waititi</div></html>");
JLabel castLabel2 = new JLabel("<html><div style='text-align:center; color: white;font-size:13px;margin-left:500px;'><u>Cast:</u> Natalie Portman</div></html>");
JLabel castLabel3 = new JLabel("<html><div style='text-align:center; color: white;font-size:13px;margin-left:500px;'><u>Cast:</u> Chris Hemsworth</div></html>");
