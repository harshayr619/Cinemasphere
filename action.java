...
// Add ActionListener to registerItem
        ...
        JLabel paragraphLabel = new JLabel("<html><h1 style='text-align: center;font-size:24px;color:white;'><u>Action Movies:</u></h1>" +
                "</div><br></html>");
...
+ "cinemaproject1\\src\\cinemaproject1\\Deadpool_(2016_poster).png",
            "C:\\Users\\hp\\OneDrive\\Documents\\NetBeansProjects\\"
+ "cinemaproject1\\src\\cinemaproject1\\Iron_Man_(2008_film)_poster.jpg",
            "C:\\Users\\hp\\OneDrive\\Documents\\NetBeansProjects\\cinemaproject1"
+ "\\src\\cinemaproject1\\The_Amazing_Spider-Man_(film)_poster.jpg",
            "C:\\Users\\hp\\OneDrive\\Documents\\NetBeansProjects\\cinemaproject1"
+ "\\src\\cinemaproject1\\The_Batman_(film)_poster.jpg",
            "C:\\Users\\hp\\OneDrive\\Documents\\NetBeansProjects\\cinemaproject1"
+ "\\src\\cinemaproject1\\The_Dark_Knight_(2008_film).jpg",
            "C:\\Users\\hp\\OneDrive\\Documents\\NetBeansProjects\\cinemaproject1"
+ "\\src\\cinemaproject1\\p9259673_p_v8_ag.jpg"
        };
        String[] captions = {"<html><h2 style='color:white;'>Deadpool</html></h2>", "<html><h2 style='color:white;'>IronMan</html></h2>",
"<html><h2 style='color:white;'>The Amazing Spiderman</html></h2>", "<html><h2 style='color:white;'>The Batman</html></h2>", "<html><h2 style='color:white;'>The Dark Knight</html></h2>", "<html><h2 style='color:white;'>Man of Steel</html></h2>"};
        for (int i = 0; i < 6; i++) {
            ...
            captionLabel.addMouseListener(new MouseAdapter() {
                ...
                public void mouseClicked(MouseEvent e) {
                    if (index == 0) {
                        ...
                        deadpool deadpoolPage = new deadpool();
                        deadpoolPage.setVisible(true);
                        dispose(); // Close the current frame
                    } else if (index == 1) {
                        // Clicked on Interstellar caption, navigate to Interstellar page
                        ironman ironmanPage = new ironman();
                        ironmanPage.setVisible(true);
                        dispose(); // Close the current frame
                    } else if (index == 2) {
                        ...
                        // Clicked on KGF caption, navigate to KGF page
                        conjuring conjuringPage = new conjuring();
                        conjuringPage.setVisible(true);
                        dispose(); // Close the current frame
                    }
